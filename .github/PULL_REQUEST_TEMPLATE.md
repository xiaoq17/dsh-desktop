...
Fixes #(issue) — or "No related issue."

## Checklist

- [ ] `bash -n` passes on any shell scripts I touched (`scripts/build.sh`,
      `scripts/make-dmg.sh`, `scripts/install.sh`, `scripts/publish-update.sh`,
